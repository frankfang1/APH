...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "鼎新远程协助"),
        ("desk_tip", "请告知您的售后服务工程师下面的ID和密码以提供帮助。"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 鼎新远程协助 网络..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动远程服务"),
        ("Service is running", "服务正在运行"),
        ("Service is not running", "服务未运行"),
        ("not_ready_status", "未就绪，请检查网络连接"),
        ("Control Remote Desktop", "控制远程设备"),
        ("Transfer file", "传输文件"),
        ("Connect", "连接"),
        ...
        ("Website", "公司官网"),
        ("About", "关于"),
        ("Slogan_tip", "敬天爱人，止于至善！\n\n为了您的数据安全，不使用本软件时请关闭本软件"),
        ("Privacy Statement", "武汉鼎新惠康科技发展有限公司"),
        ("Mute", "静音"),
        ("Build Date", "By Frank"),
        ("Version", "软件版本"),
        ("Home", "主界面"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，如需要更高权限，点击下面的按钮将 鼎新远程协助 安装到系统。"),
        ("Click to upgrade", "有更新，不建议升级！"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "有更新，不建议升级！"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 鼎新协助 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 鼎新协助 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
